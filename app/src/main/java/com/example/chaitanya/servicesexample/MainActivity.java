...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart = (Button) findViewById(R.id.btn_start_service);
        buttonStop = (Button) findViewById(R.id.btn_stop_service);
        buttonNext = (Button) findViewById(R.id.btn_next_activity);
